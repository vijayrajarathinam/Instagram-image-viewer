  ...
  render() {
    ...
    return (
      <div>
        ...
        <Header
          profile_picture={profileImage} //{this.state.profile_picture}
                ...
                <Grid key={image.id} item xs={12} sm={6} className="grid-item">
                  <Card className={classes.card}>
                    <CardHeader
                      ...
                      avatar={
                        <Avatar
                          src={profileImage} //{image.caption.from.profile_picture}
                    ...
                    <CardContent>
                      ...
                      <div className="image-caption">{image.caption.text.split("\n")[0]}</div>
                      <div className="image-hashtags">{image.caption.text.split("\n")[1]}</div>
                      <div>
                        <IconButton
                      ...
                      <FormControl className={classes.comment} fullWidth={true}>
                        ...
                        <Input
                          ...
                          name="commentText"
                          onChange={(event) => this.onCommentTextChangeHandler(event, image.id)}
                          value={image.id === this.state.commentText.id ? this.state.commentText.text : ""}
                        />
                        <Button
                          variant="contained"
                          color="primary"
