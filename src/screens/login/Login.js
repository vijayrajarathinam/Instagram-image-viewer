...
class Login extends Component {
  ...
  loginClickHandler = () => {
    ...
    let accessToken = "345213434576.f0hgf45.56g63ab2f88d4f9nxjewif3r8i223567s2";
        ...
        {this.state.isLoggedIn === true ? (
          ...
          <div>
            ...
            <Card className="login-card">
              ...
              <br />
              <br />
              <FormHelperText className={this.state.incorrectUsernamePasswordMessage}>
                <span className="red" style={{ fontSize: "14px" }}>
                  Incorrect username and/or password
                </span>
              </FormHelperText>
              <br />
              <Button variant="contained" color="primary" onClick={this.loginClickHandler} className="login-btn">
                LOGIN
              </Button>
            </Card>
          </div>
